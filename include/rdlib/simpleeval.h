...
extern uint_t Evaluate(const simplevars_t& vars, const AString& str, uint_t pos, AValue& val, AString& errors);
extern bool Evaluate(const simplevars_t& vars, const AString& expr, AValue& val, AString& errors);
