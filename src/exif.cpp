...
////////////////////////////////////////////////////////////////////////////////
bool Exif::DecodeExif(FILE * hFile)
{
    int a;
    int HaveCom = 0;
...
--------------------------------------------------------------------------*/
bool Exif::process_EXIF(unsigned char * CharBuf, unsigned int length)
{
...
--------------------------------------------------------------------------*/
unsigned long Exif::Get32u(void * Long)
{
...
--------------------------------------------------------------------------*/
bool Exif::ProcessExifDir(unsigned char * DirStart, unsigned char * OffsetBase, unsigned ExifLength,
...
--------------------------------------------------------------------------*/
double Exif::ConvertAnyFormat(void * ValuePtr, int Format)
{
    double Value;
    Value = 0;

    switch(Format){
        case FMT_SINT8_T:     Value = *(signed char *)ValuePtr;  break;
...
////////////////////////////////////////////////////////////////////////////////
void Exif::process_COM (const unsigned char * Data, int length)
{
    int ch;
...
////////////////////////////////////////////////////////////////////////////////
void Exif::process_SOFn (const unsigned char * Data, int marker)
{
